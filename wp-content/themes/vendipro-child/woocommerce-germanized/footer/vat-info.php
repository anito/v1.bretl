...
<?php if ( get_option('woocommerce_gzd_small_enterprise') != 'yes' ) : ?>
	...
	<p class="footer-info sale-info">Copyright &copy; <?php echo date('Y'); ?>&nbsp;<span>CGD Sokatsch</span><sup>&reg;</sup>
        <span class="">Design by </span><span class="powered-by-webpremiere"><a href="https://webpremiere.de"  target="_blank"><img class="logo" src="https://files.webpremiere.de/f/943f104d3157409f9c32/?dl=1" alt="WebPremiere"></a><sup>&reg;</sup></span>
	</p>
<?php else : ?>
